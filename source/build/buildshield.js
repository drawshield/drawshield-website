...
'bar gemel ~x-linetype~ ~x-tincture~',"bar gemel", '/catalog/ordinaries/fess/bar-gemel-+.png',
'bar ~x-linetype~ ~x-tincture~',"bar", '/catalog/ordinaries/fess/bar-+.png',
'barrulet ~x-tincture~',"barrulet", '/catalog/ordinaries/diminutive/barrulet.png',
'base pointed ~x-tincture~',"base pointed", '/catalog/ordinaries/minor/base-pointed.png',
'base ~x-linetype~ ~x-tincture~',"base", '/catalog/ordinaries/major/base-+.png',
'baton ~x-tincture~',"baton", '/catalog/ordinaries/bend/baton.png',
'bend couped ~x-linetype~ ~x-tincture~',"bend couped", '/catalog/ordinaries/bend/bend-couped-+.png',
'bend voided ~x-linetype~ ~x-tincture~',"bend voided", '/catalog/ordinaries/bend/bend-voided-+.png',
'bend ~x-linetype~ ~x-tincture~',"bend", '/catalog/ordinaries/major/bend-+.png',
'bendlet sinister ~x-linetype~ ~x-tincture~',"bendlet sinister", '/catalog/ordinaries/diminutive/bendlet-sinister-+.png',
'bendlet ~x-linetype~ ~x-tincture~',"bendlet", '/catalog/ordinaries/bend/bendlet-+.png',
'bordure ~x-tincture~',"bordure", '/catalog/ordinaries/major/bordure.png',
'canadian pale ~x-linetype~ ~x-tincture~',"canadian pale", '/catalog/ordinaries/pale/canadian-pale-+.png',
'canton sinister ~x-linetype~ ~x-tincture~',"canton sinister", '/catalog/ordinaries/diminutive/canton-sinister-+.png',
'canton ~x-linetype~ ~x-tincture~',"canton", '/catalog/ordinaries/diminutive/canton-+.png',
'chevron burst ~x-tincture~',"chevron burst", '/catalog/ordinaries/chevrons/chevron-burst.png',
'chevron couched sinister ~x-linetype~ ~x-tincture~',"chevron couched sinister", '/catalog/ordinaries/chevrons/chevron-couched-sinister-+.png',
'chevron couched ~x-linetype~ ~x-tincture~',"chevron couched", '/catalog/ordinaries/chevrons/chevron-couched-+.png',
'chevron disjointed ~x-tincture~',"chevron disjointed", '/catalog/ordinaries/chevrons/chevron-disjointed.png',
'chevron fracted ~x-tincture~',"chevron fracted", '/catalog/ordinaries/chevrons/chevron-fracted.png',
'chevron ploye ~x-tincture~',"chevron ploye", '/catalog/ordinaries/chevrons/chevron-ploye.png',
'chevron removed ~x-tincture~',"chevron removed", '/catalog/ordinaries/chevrons/chevron-removed.png',
'chevron rompu ~x-linetype~ ~x-tincture~',"chevron rompu", '/catalog/ordinaries/chevrons/chevron-rompu-+.png',
'chevron ~x-linetype~ ~x-tincture~',"chevron", '/catalog/ordinaries/major/chevron-+.png',
'chevronel ~x-tincture~',"chevronel", '/catalog/ordinaries/chevrons/chevronel.png',
'chief couped ~x-linetype~ ~x-tincture~',"chief couped", '/catalog/ordinaries/major/chief-couped-+.png',
'chief pointed ~x-tincture~',"chief pointed", '/catalog/ordinaries/minor/chief-pointed.png',
'chief ~x-linetype~ ~x-tincture~',"chief", '/catalog/ordinaries/major/chief-+.png',
'closet ~x-linetype~ ~x-tincture~',"closet", '/catalog/ordinaries/fess/closet-+.png',
'crancelin ~x-tincture~',"crancelin", '/catalog/ordinaries/bend/crancelin.png',
'cross formy ~x-tincture~',"cross formy", '/catalog/ordinaries/cross/cross-formy.png',
'cross parted fretty ~x-tincture~',"cross parted fretty", '/catalog/ordinaries/cross/cross-parted-fretty.png',
'cross quarter pierced ~x-tincture~',"cross quarter pierced", '/catalog/ordinaries/cross/cross-quarter-pierced.png',
'cross tripartite fretty ~x-tincture~',"cross tripartite fretty", '/catalog/ordinaries/cross/cross-tripartite-fretty.png',
'dance ~x-tincture~',"dance", '/catalog/ordinaries/fess/dance.png',
'double tressure flory counter flory ~x-tincture~',"double tressure flory counter flory", '/catalog/ordinaries/minor/double-tressure-flory-counter-flory.png',
'double tressure ~x-tincture~',"double tressure", '/catalog/ordinaries/major/double-tressure.png',
'endorse ~x-linetype~ ~x-tincture~',"endorse", '/catalog/ordinaries/pale/endorse-+.png',
'enty in point ~x-tincture~',"enty in point", '/catalog/ordinaries/minor/enty-in-point.png',
'fess between 2 chevrons ~x-tincture~',"fess between 2 chevrons", '/catalog/ordinaries/fess/fess-between-2-chevrons.png',
'fess couped ~x-linetype~ ~x-tincture~',"fess couped", '/catalog/ordinaries/fess/fess-couped-+.png',
'fess voided ~x-tincture~',"fess voided", '/catalog/ordinaries/fess/fess-voided.png',
'fess ~x-linetype~ ~x-tincture~',"fess", '/catalog/ordinaries/major/fess-+.png',
'fillet cross ~x-linetype~ ~x-tincture~',"fillet cross", '/catalog/ordinaries/diminutive/fillet-cross-+.png',
'fillet saltire ~x-linetype~ ~x-tincture~',"fillet saltire", '/catalog/ordinaries/diminutive/fillet-saltire-+.png',
'flaunch ~x-tincture~',"flaunch", '/catalog/ordinaries/minor/flaunch.png',
'ford',"ford", '/catalog/ordinaries/minor/ford.png',
'fret couped ~x-tincture~',"fret couped", '/catalog/ordinaries/minor/fret-couped.png',
'fret ~x-tincture~',"fret", '/catalog/ordinaries/minor/fret.png',
'gore ~x-tincture~',"gore", '/catalog/ordinaries/minor/gore.png',
'gorge ~x-tincture~',"gorge", '/catalog/ordinaries/minor/gorge.png',
'graft ~x-linetype~ ~x-tincture~',"graft", '/catalog/ordinaries/minor/graft-+.png',
'gusset ~x-linetype~ ~x-tincture~',"gusset", '/catalog/ordinaries/minor/gusset-+.png',
'gyron ~x-linetype~ ~x-tincture~',"gyron", '/catalog/ordinaries/minor/gyron-+.png',
'humet ~x-linetype~ ~x-tincture~',"humet", '/catalog/ordinaries/fess/humet-+.png',
'inescutcheon ~x-tincture~',"inescutcheon", '/catalog/ordinaries/major/inescutcheon.png',
'label entire ~x-tincture~',"label entire", '/catalog/ordinaries/major/label-entire.png',
'lozenge throughout ~x-tincture~',"lozenge throughout", '/catalog/ordinaries/minor/lozenge-throughout.png',
'mountain ~x-tincture~',"mountain", '/catalog/ordinaries/minor/mountain.png',
'orle ~x-tincture~',"orle", '/catalog/ordinaries/major/orle.png',
'pale voided ~x-tincture~',"pale voided", '/catalog/ordinaries/pale/pale-voided.png',
'pale ~x-linetype~ ~x-tincture~',"pale", '/catalog/ordinaries/major/pale-+.png',
'palet gemel ~x-linetype~ ~x-tincture~',"palet gemel", '/catalog/ordinaries/pale/palet-gemel-+.png',
'palet ~x-linetype~ ~x-tincture~',"palet", '/catalog/ordinaries/pale/palet-+.png',
'pall ~x-linetype~ ~x-tincture~',"pall", '/catalog/ordinaries/major/pall-+.png',
'pallium ~x-tincture~',"pallium", '/catalog/ordinaries/pile/pallium.png',
'pile embowed ~x-tincture~',"pile embowed", '/catalog/ordinaries/pile/pile-embowed.png',
'pile throughout ~x-tincture~',"pile throughout", '/catalog/ordinaries/pile/pile-throughout.png',
'pile ~x-tincture~',"pile", '/catalog/ordinaries/major/pile.png',
'plain cross ~x-linetype~ ~x-tincture~',"plain cross", '/catalog/ordinaries/major/plain-cross-+.png',
'point dexter ~x-linetype~ ~x-tincture~',"point dexter", '/catalog/ordinaries/minor/point-dexter-+.png',
'point in point ~x-linetype~ ~x-tincture~',"point in point", '/catalog/ordinaries/minor/point-in-point-+.png',
'point sinister ~x-linetype~ ~x-tincture~',"point sinister", '/catalog/ordinaries/minor/point-sinister-+.png',
'quarter ~x-linetype~ ~x-tincture~',"quarter", '/catalog/ordinaries/major/quarter-+.png',
'riband ~x-linetype~ ~x-tincture~',"riband", '/catalog/ordinaries/bend/riband-+.png',
'saltire parted fretty ~x-tincture~',"saltire parted fretty", '/catalog/ordinaries/cross/saltire-parted-fretty.png',
'saltire ~x-linetype~ ~x-tincture~',"saltire", '/catalog/ordinaries/major/saltire-+.png',
'scarpe ~x-tincture~',"scarpe", '/catalog/ordinaries/bend/scarpe.png',
'shakefork ~x-linetype~ ~x-tincture~',"shakefork", '/catalog/ordinaries/diminutive/shakefork-+.png',
'square flaunch ~x-tincture~',"square flaunch", '/catalog/ordinaries/minor/square-flaunch.png',
'tierce sinister ~x-linetype~ ~x-tincture~',"tierce sinister", '/catalog/ordinaries/major/tierce-sinister-+.png',
'tierce ~x-linetype~ ~x-tincture~',"tierce", '/catalog/ordinaries/major/tierce-+.png',
'tressure ~x-tincture~',"tressure", '/catalog/ordinaries/major/tressure.png',
