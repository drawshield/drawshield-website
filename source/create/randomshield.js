...
var positions = new Array (
 "in dexter flank", "in sinister flank", "in dexter chief", "in sinister chief",
...
"chess rook", "castle", "ox(en)", "fir tree", "salmon", "mill wheel", "cog wheel", "water wheel",
"estoile", "church bell", "hawk bell", "bomb", "saxon crown", "caltrap", "sun", "full moon",
    ...
    "cockatrice", "hydra", "salamander", "unicorn", "welsh dragon", "dog", "dog's head", "grey hound",
    "tulip", "apple", "pear", "lemon", "quail", "bat", "lotus", "duck", "swan", "popinjay",
    "vine", "bullrush", "hurst", "drum", "trumpet"
);

var fixed = new Array (
"bezant", "golpe", "hurt", "pellet", "plate", "pomme",  "torteau(x)", "fountain", "rainbow"
);
...
"mounted knight {colour} plumed and caparisoned {colour}", "archer {colour} hat, boots and belt {colour}",
"blacksmith {colour} tools and apron {colour}"
);
...
var singles = new Array (
  ...
  "purpure",  "purpure", "purpure", "purpure", "purpure",
  "gules",    "gules",   "gules",   "gules",   "gules",
...
"{2-4} {charge} in bend sinister {ucolour}", "{3} {charge} in pile {ucolour}",
...
function randomShield(e) {
  used_colours = "";
  if (e.shiftKey) {
    var blazon = new String(s_templates[parseInt(Math.random()*s_templates.length)]);
  } else {
