...
//  document.getElementById('caption').firstChild.nodeValue = "Go back one step";
    bStack = [];
    qStack = [];
    requestSVG('/include/drawshield.php?&highlight=0&size=' + size + '&blazon=Argent%20the%20word%20pauldron%20sable%20the%20word%20Your%20sable%20in%20chief%20the%20word%20here%20in%20base%20sable&shape=pauldron','shieldimg');
}
